...
public final class DropdownItemBinding implements ViewBinding {
  ...
  private DropdownItemBinding(@NonNull TextView rootView, @NonNull TextView dropdownMenu) {
  ...
  public static DropdownItemBinding bind(@NonNull View rootView) {
    ...
    TextView dropdownMenu = (TextView) rootView;

    return new DropdownItemBinding((TextView) rootView, dropdownMenu);
  }
}
